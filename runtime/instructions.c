...
void read_operand_uint16(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._index.index = (uint16_t) ReadU2(frame);
}

void read_operand_int16(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._index._offset = ReadU2(frame);
}

void read_operand_uint8(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._index.index = (uint16_t) ReadU1(frame);
}

void read_operand_int8(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._index._int8 = (int8_t) ReadU1(frame);
}

void read_operand_int32(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._const = (int32_t) ReadU4(frame);
}
...
void read_operand_iinc(Instruction *instruction, Frame *frame) {
    frame->localvars->_operand._index.index = ReadU1(frame);
    frame->localvars->_operand._const = ReadU1(frame);
}
